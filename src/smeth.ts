...
bot.on('message', msg => {
  ...
  if (msg.content === 'f' && msg.author !== bot.user) {
	...
	.setThumbnail('https://h45vs1s00ar1vknck1y9srp1-wpengine.netdna-ssl.com/wp-content/uploads/2018/01/f-grade.png', 'https://www.urbandictionary.com/define.php?term=F')
	.addFields(
		{ name: 'f', value: 'f' },
		{ name: '\u200B', value: '\u200B' },
